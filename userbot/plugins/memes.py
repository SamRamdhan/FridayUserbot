...
RENDISTR = [
    ...
    "`Bahkan ketika nyenyak menghampiri tidurku, aku masih berharap dirimu menungguku diruang mimpi.`",
    ...
    "`Maaf jika setiap pesanku bergelimang rayuan, membuat seakan-akan semuanya terlalu berlebihan. Aku anggap itu belum ada apa-apanya dibanding kebahagiaan yang kudapat atas kagumku pada parasmu.`",
    ...
    "`Semoga semua pesan yang selalu kukirim padamu tak membuatmu menjauhiku. Aku hanya takut jika kau pergi, bahagiaku juga pergi.`",
